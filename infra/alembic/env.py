...
from shared_config.persistence import metadata  # noqa: E402
...
def run_migrations_online() -> None:
    ...
    if connectable is None:
        # Running via alembic CLI - create our own connection
        ...
        # Running programmatically with pre-existing connection
